...
HD_PWD='/home/m1/radi/Documents/aeo/Tp1_exos/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log exo2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source exo2.tcl
