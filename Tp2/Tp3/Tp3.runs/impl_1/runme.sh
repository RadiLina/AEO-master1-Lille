...
HD_PWD='/home/m1/radi/Documents/aeo/Tp2/Tp3/Tp3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Count1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Count1.tcl -notrace
